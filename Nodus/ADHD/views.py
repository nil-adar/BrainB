...
def get_tips(percentages, lang='he'):
    if lang == 'he':
        ...
        Hyperactivity = "שלב פעילויות גופניות והפסקות תנועה במהלך היום לניהול אנרגיה. השתתף בפעילויות מובנות עם כללים ברורים. שחק משחקים שמלמדים שליטה עצמית. השתמש בטבלת התנהגות לתגמול על התנהגויות חיוביות. השק את האנרגיה שלך בספורט, יצירה ומשחקים מאורגנים. קח הפסקות קצרות בעת הצורך. השתמש בתגמולים מיידיים כדי להבין מה מצופה ממך."
        Inattention = "צור שגרה יומית עקבית והשתמש בעזרים חזותיים כדי לזכור משימות. חלק הנחיות לצעדים קטנים וחזור עליהן כדי לוודא שהבנת. צור אזור שקט לפעילויות ממוקדות. חגוג הישגים קטנים עם שבח מיידי. בדוק את עצמך או בקש עזרה כדי להישאר ממוקד. הפחת הסחות דעת ויעד מטרות קטנות וברורות."
    ...
    tips_array = [combined, Hyperactivity, Inattention, no_adhd]
