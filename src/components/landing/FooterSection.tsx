...
export function FooterSection({
  ...
  return (
    <footer
      className="bg-secondary/30 py-8 md:py-12 px-4 md:px-10 lg:px-20"
      dir={isRTL ? "rtl" : "ltr"}
    >
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          >
            <div
              className={`flex -mt-2 md:-mt-12 ${
                isRTL
                  ? "justify-center sm:justify-end"
                  : "justify-center sm:justify-start"
              }`}
            >
              <Logo size={isMobile ? "sm" : "md"} showText={true} />
            </div>
            <p
              ...
              <div className="space-y-2">
                <div
                  className={`flex items-center gap-2 ${
                    isRTL
                      ? "justify-center sm:justify-end flex-row-reverse"
                      : "justify-center sm:justify-start"
                  }`}
                >
                  <Mail size={isMobile ? 14 : 16} className="shrink-0" />
                  <span className="text-sm md:text-base">
                    {contact.email} nil.adar@e.braude.ac.il
                  </span>
                </div>
                <div
                  className={`flex items-center gap-2 ${
            ...
            <ul className="space-y-2">
              <li>
                <Button
                  ...
                  onClick={() =>
                    navigate("/login", { state: { userType: "teacher" } })
                  }
                >
                  {login}
                </Button>
        ...
        <div
          className={`flex flex-col md:flex-row justify-center md:justify-between items-center mt-8 md:mt-12 pt-6 md:pt-8 border-t border-border ${
