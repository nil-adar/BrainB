  ...
  return (
    <div className="flex flex-col justify-self-end order-2 md:order-3 w-full">
      <div className="mb-3 bg-gradient-to-r from-blue-100 to-purple-100 dark:from-gray-800/80 dark:to-purple-900/80 backdrop-blur-sm p-3 rounded-lg shadow-sm">
        <h2 className="text-xl font-medium text-blue-800 dark:text-blue-300">{tasksTitle}</h2>
        <span className="text-sm font-medium bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm px-2 py-0.5 rounded-full shadow-sm text-purple-600 dark:text-purple-300">{todayText}</span>
      </div>
