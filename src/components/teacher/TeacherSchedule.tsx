            ...
            <>
              <Table className="table-fixed w-full">
                <TableHeader className="bg-muted/40">
                  <TableRow>
                    <TableHead
                      className="w-[120px] font-bold text-right"
                      dir="rtl"
                    >
                      {language === "he" ? "שעה" : t.time}
                    </TableHead>
                    <TableHead
                      className="w-[25%] font-bold text-right"
                      dir="rtl"
                    >
                      {language === "he" ? "מקצוע" : t.subject}
                    </TableHead>
                    <TableHead
                      className="w-[30%] font-bold text-right"
                      dir="rtl"
                    >
                      {language === "he" ? "נושא" : t.topic || "Topic"}
                    </TableHead>
                    <TableHead
                      className="w-[15%] font-bold text-right"
                      dir="rtl"
                    >
                      {language === "he" ? "כיתה" : t.room}
                    </TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                    ...
                    scheduleData.flatMap((event, index) =>
                      event.schedule.map((slot, subIndex) => (
                        <TableRow
                          key={`${index}-${subIndex}`}
                          className={
                            (index + subIndex) % 2 === 0 ? "bg-muted/10" : ""
                          }
                        >
                          <TableCell
              ...
              >
                <Button
                  ...
                  className="bg-emerald-200 text-white hover:opacity-80 text-zinc-800"
                >
                  {language === "he"
                    ? " הוסף אירוע אישי ➕"
                    : "Add Personal Event ➕"}
